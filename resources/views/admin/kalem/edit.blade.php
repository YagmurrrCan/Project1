                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header" data-background-color="purple">
                            <h4 class="title">Kalem Düzenle</h4>
                            <p class="category">{{$data[0]["name"]}}</p>
                        </div>
                        <div class="card-content">
                            <form enctype="multipart/form-data" action="{{route("admin.kalem.edit.post", ["id"=>$data[0]["id"]])}}" method="POST">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <button type="submit" class="btn btn-primary pull-right">Kalem Düzenle</button>
